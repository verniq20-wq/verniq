...
export function Toaster() {
  ...
  return (
    <div
      aria-live="polite"
      className="pointer-events-none fixed inset-x-0 top-[calc(env(safe-area-inset-top)+4.25rem)] z-[60] flex flex-col items-center gap-2 px-3 md:bottom-6 md:top-auto md:items-end md:px-6"
    >
